...
public class AssignmentHistory {
    ...
    private String assignmentHistoryStatus;
    Team TeamObject;
    ...
    public String getAssignmentHistoryStatus() {
        return assignmentHistoryStatus;
    }
    ...
    public void setEffectiveDateBegin(String effectiveDateBegin) {
        this.effectiveDateBegin = effectiveDateBegin;
    }

    public void setAssignmentHistoryStatus(String assignmentHistoryStatus) {
        this.assignmentHistoryStatus = assignmentHistoryStatus;
    }
